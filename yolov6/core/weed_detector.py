...
class YOLOv6:
    def __init__(self, 
        weights=osp.join(ROOT, 'best_ckpt.pt'),
        ...
        hide_conf=False, 
        half= False):
        """This script defines a class named YOLOv6 that allows the usage of the 
        YOLOv6 model in another Python script. 
        The class provides methods for performing inference on single images (eval) and camera streams or directories (infer).

        Args:
            weights (_type_, optional): _description_. Defaults to osp.join(ROOT, 'best_ckpt.pt').
            source (_type_, optional): _description_. Defaults to osp.join(ROOT, 'data/images').
            webcam (bool, optional): _description_. Defaults to False.
            webcam_addr (int, optional): _description_. Defaults to 0.
            yaml (_type_, optional): _description_. Defaults to None.
            img_size (int, optional): _description_. Defaults to 640.
            conf_thres (float, optional): _description_. Defaults to 0.4.
            iou_thres (float, optional): _description_. Defaults to 0.45.
            max_det (int, optional): _description_. Defaults to 1000.
            device (str, optional): _description_. Defaults to ''.
            save_txt (bool, optional): _description_. Defaults to False.
            not_save_img (bool, optional): _description_. Defaults to False.
            save_dir (_type_, optional): _description_. Defaults to None.
            view_img (bool, optional): _description_. Defaults to True.
            classes (_type_, optional): _description_. Defaults to None.
            agnostic_nms (bool, optional): _description_. Defaults to False.
            project (_type_, optional): _description_. Defaults to osp.join(ROOT, 'runs/inference').
            name (str, optional): _description_. Defaults to 'exp'.
            hide_labels (bool, optional): _description_. Defaults to False.
            hide_conf (bool, optional): _description_. Defaults to False.
    ...
    def eval(self, img_src, conf_thres, iou_thres, classes, agnostic_nms, max_det):
